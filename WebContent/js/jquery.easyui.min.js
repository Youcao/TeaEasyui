...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,interval:200,missingMessage:"这里输入不能为空",invalidMessage:null,tipPosition:"right",deltaX:0,deltaY:0,novalidate:false,editable:true,disabled:false,readonly:false,validateOnCreate:true,validateOnBlur:false,events:{focus:_4ca,blur:_4ce,mouseenter:_4d1,mouseleave:_4d4,click:function(e){
var t=$(e.data.target);
...
},message:"请输入一个合法的邮箱地址"},url:{validator:function(_4f9){
...
},message:"请输入一个合法的URL"},length:{validator:function(_4fa,_4fb){
var len=$.trim(_4fa).length;
return len>=_4fb[0]&&len<=_4fb[1];
},message:"请输入一个 {0} 到 {1}之间的值"},remote:{validator:function(_4fc,_4fd){
var data={};
data[_4fd[1]]=_4fc;
var _4fe=$.ajax({url:_4fd[0],dataType:"json",data:data,async:false,cache:false,type:"post"}).responseText;
return _4fe=="true";
},message:"请正确填充这个字段"}},onBeforeValidate:function(){
